...
*/
newquote = quote.padEnd(70, '.');
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
newq1uote = quote.padStart(70, '.');
/*
...
*/
quote.concat(" ", to).replace("Stark", "Lannister");
/*
...
*/
console.log(from.startsWith('A'), quote.startsWith(`A`), to.startsWith(`A`));